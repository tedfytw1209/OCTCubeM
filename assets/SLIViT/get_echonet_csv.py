...
if __name__ == "__main__":
    ...
    parser.add_argument('--csv_path', default='./meta/echonet/FileList.csv', # home_directory + '/EchoNet/EchoNet-Dynamic/FileList.csv',
                        help='Path to the FileList.csv that comes with the dataset.')
    parser.add_argument('--data_path', default=home_directory + '/EchoNet/EchoNet-Dynamic/Videos_tiff/'
