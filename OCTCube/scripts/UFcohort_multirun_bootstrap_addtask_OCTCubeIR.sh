...
# OCTCube-IR dual-modality bootstrap over the addtask studies. For each dataset,
# one 10-seed bootstrap job (seeds 1..10) is submitted via SCRIPT.
#bash scripts/UFcohort_multirun_bootstrap_addtask_OCTCubeIR.sh scripts/UFcohort_multirun_bootstrap_OCTCubeIR.sh flash_attn_vit_large_patch16 2 AUC 500
