...
k_folds=5
LOG_DIR=$HOME/log_pt/
OUTPUT_DIR=./outputs_ft_st/finetune_inhouse_multi_label_${disease}_3D_correct_patient_singlefold/
CUDA_VISIBLE_DEVICES=0 python -m main_finetune_downstream_inhouse_singlefold --nb_classes 9 \
