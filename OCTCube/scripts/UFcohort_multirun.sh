...
DATASETS=(DR_filtered_all_split Glaucoma_filtered_all_split)  # List of datasets
CLASSES=(5 4)  # Number of classes for each dataset
TASK_MODES=(multi_cls multi_cls)  # Task mode, can be changed as needed
for i in "${!DATASETS[@]}"
do
