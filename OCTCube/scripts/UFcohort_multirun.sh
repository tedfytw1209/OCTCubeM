...
#bash scripts/UFcohort_multirun.sh scripts/finetune_UFcohort.sh flash_attn_vit_large_patch16 2 mcc --testval
...
do
    ...
    sbatch $SCRIPT $DATASET $MODEL $NUM_CLASS $Eval_score $ADDCMD
