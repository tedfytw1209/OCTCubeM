...
# Example usage: sbatch scripts/finetune_UFcohort_IRB2024v5_dual.sh AMD_all_split flash_attn_vit_large_patch16 2 AUPRC binary_cls --testval
...
python main_finetune_downstream_UFcohort_dual.py --nb_classes $Num_CLASS \
    ...
    --drop_path 0.2 \
    --num_workers 0 \
    --oct_finetune $ROOT/$prefix/OCTCubeM/ckpt/OCTCube.pth \
    --fundus_finetune $ROOT/$prefix/OCTCubeM/ckpt/mm_octcube_ir.pt \
    --return_bal_acc \
    --not_print_logits \
    ${ADDCMD}
