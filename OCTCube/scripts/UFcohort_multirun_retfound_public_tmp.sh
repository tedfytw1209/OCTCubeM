...
python main_finetune_downstream_glaucoma_correct_visit.py --nb_classes 2 --data_path /blue/ruogu.fang/tienyuchang/OCTCubeM/assets/ext_oph_datasets/GLAUCOMA/glaucoma_processed/ --rank -1 --dataset_mode volume --iterate_mode visit --name_split_char - --patient_idx_loc 1 --max_frames 60 --num_frames 60 --k_folds 10 --few_shot --task finetune_glaucoma_--few_shot_3D_RETFound_10folds_correct_visit --task_mode binary_cls --val_metric AUPRC --input_size 128 --log_dir /blue/ruogu.fang/log_pt/ --output_dir ./outputs_ft_st/finetune_glaucoma_--few_shot_3D_RETFound_10folds_correct_visit/ --batch_size 4 --val_batch_size 16 --warmup_epochs 5 --world_size 1 --model flash_attn_vit_large_patch16_3DSliceHead --patient_dataset_type 3D_flash_attn --transform_type monai_3D --color_mode gray --epochs 100 --blr 5e-3 --layer_decay 0.65 --weight_decay 0.05 --drop_path 0.2 --num_workers 10 --finetune /blue/ruogu.fang/tienyuchang/OCTCubeM/ckpt/RETFound_oct_weights.pth --return_bal_acc --load_non_flash_attn_to_flash_attn --not_print_logits