...
dataset_path = 'OCTCubeM/assets/ext_oph_datasets/HCMS/image_resized/'
dataset_name = 'hcms'
...
def get_args_parser():
    ...
    parser.add_argument('--slivit_num_of_patches', default=18, type=int, help='number of patches for SLIViT')
    ...
    parser.add_argument('--iterate_mode', default='patient', type=str, choices=['visit', 'patient'], help='iterate mode for the patient dataset, hcms uses patient')
    parser.add_argument('--name_split_char', default='_', type=str, help='split character for the image filename')
    parser.add_argument('--patient_idx_loc', default=6, type=int, help='patient index location in the image filename, e.g., 2 for amd_oct_2_1.png')
    ...
    if not args.patient_dataset:
        ...
        if args.k_fold:
            ...
            if args.iterate_mode == 'patient':
                ...
                folds = misc.hcms_generate_sublists(patient_indices, N1=14, N2=21, k=[3, 4], iterations=args.k_folds, random_state=0)
